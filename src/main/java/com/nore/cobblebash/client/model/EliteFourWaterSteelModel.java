...
public class EliteFourWaterSteelModel extends EntityModel<GymLeaderEntity> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(CobbleBash.MODID, "elite_four_water_steel"), "main");
