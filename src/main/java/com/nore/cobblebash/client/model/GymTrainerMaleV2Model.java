...
public class GymTrainerMaleV2Model extends EntityModel<GymTrainerEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(CobbleBash.MODID, "gym_trainer_male_v2"),
            "main"
    );
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        .texOffs(32, 32).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.15F)), PartPose.offset(0.0F, -12.0F, 0.0F));
        ...
        PartDefinition Left_Leg = Legs.addOrReplaceChild("Left_Leg", CubeListBuilder.create().texOffs(0, 32).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
        .texOffs(0, 116).addBox(-2.0F, 10.0F, -3.0F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.1F))
        .texOffs(12, 125).addBox(-1.0F, 9.0F, -2.2F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
        .texOffs(0, 123).addBox(-2.0F, 7.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.1F)), PartPose.offset(3.8F, 0.0F, 0.0F));

        PartDefinition Right_Leg = Legs.addOrReplaceChild("Right_Leg", CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
        .texOffs(0, 123).addBox(-2.0F, 7.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.1F))
        .texOffs(0, 116).addBox(-2.0F, 10.0F, -3.0F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.1F))
        .texOffs(12, 125).addBox(-1.0F, 9.0F, -2.2F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition bb_main = rootDefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(0, 3).addBox(2.15F, -21.3F, -2.4F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
        .texOffs(0, 5).addBox(2.15F, -21.3F, -2.1F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.2F)), PartPose.offset(0.0F, 24.0F, 0.0F));
