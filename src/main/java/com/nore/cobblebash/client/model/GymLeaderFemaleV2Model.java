...
public class GymLeaderFemaleV2Model extends EntityModel<GymLeaderEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(CobbleBash.MODID, "gym_leader_female_v2"),
            "main"
    );
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        .texOffs(0, 3).addBox(-0.4F, -1.6F, -0.4F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, 6.0F, -2.0F));
        ...
        PartDefinition bb_main = rootDefinition.addOrReplaceChild("bb_main", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));
